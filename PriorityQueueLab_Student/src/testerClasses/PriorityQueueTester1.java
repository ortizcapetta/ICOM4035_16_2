...
public class PriorityQueueTester1 {
	...
	public static void main(String[] args) {
		...
		/**
		 * EXCERCISE 4: Instead of removing elements from smallest to largest, it does it from largest to smallest
		 * this is simply due to how the 2nd comparator is implemented
		 */
		
		/**
		 * EXERCISE 6: Prioritizes removal of largest elements due to the comparator used
		 * same as what happened in Exercise 4
		 */
