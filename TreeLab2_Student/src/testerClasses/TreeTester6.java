...
public class TreeTester6 {
	public static void main(String[] args) { 
		...
		//EXERCISE 6: It doesn't matter how to you insert the elements, since the RecInsert method orders them accordingly
		//in this case, it orders them in a way that it can iterate through it from smallest to largest value
		t.insert(15); 
		t.insert(12);
		t.insert(4); 
		t.insert(9); 
