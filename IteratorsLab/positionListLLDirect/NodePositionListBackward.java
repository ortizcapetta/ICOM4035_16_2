 ...
 *
 */
public class NodePositionListBackward<T> implements PositionList<T> {

	private DNode<T> header, trailer; 
	private int count; 
	
	public NodePositionListBackward() {
	...
	public Iterable<Position<T>> positions() {
		NodePositionListBackward<Position<T>> pList = new NodePositionListBackward<Position<T>>(); 
		try { 
			if (!this.isEmpty()) { 
	...
	private static class DNode<T2> implements Position<T2> {
        ...
        private NodePositionListBackward<T2> myList;     // list it belongs to
        
        public DNode(T2 e, DNode<T2> p, DNode<T2> n, NodePositionListBackward<T2> list) { 
        	element = e; 
        	next = n; 
        	prev = p; 
        	myList = list; 
		...
		public void setList(NodePositionListBackward<T2> n) { 
			myList = n; 
		}
		public NodePositionListBackward<T2> getList() { 
			return myList; 
		}
